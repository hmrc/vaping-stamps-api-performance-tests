# vaping-stamps-api-performance-tests

Performance test suite for the `Vaping Stamps ApI`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
